...
export function fetchNamespaces({ criteria, limit, pages, page, quiet = false, timeout }) {
  return async (dispatch) => {
    ...
    try {
      const url = getNamespacesUrl(criteria, limit, offset);
      ...
      return dispatch({ type: FETCH_NAMESPACES_SUCCESS, data: { ...data, ...payload } });
    } catch(error) {
